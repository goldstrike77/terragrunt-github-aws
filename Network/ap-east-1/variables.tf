  ...
  default = [
    {
      vpc = [
        {
          ...
          subnet = [
            ...
            },
            {
              ...
              tags = {
                Name = "subnet-vpc-ap-east-1-egress-01-03"
              }
            },
            {
              availability_zone = "ap-east-1b"
              ...
              tags = {
                Name = "subnet-vpc-ap-east-1-egress-01-04"
              }
            }
          ]
        },
      ...
      eip = [
        ...
        {
          tags = {
            Name = "eipalloc-ap-east-1-egress-02"
          }
        }
      ],
      nat_gateway = [
        ...
        {
          allocation = "eipalloc-ap-east-1-egress-02"
          subnet     = "subnet-vpc-ap-east-1-egress-01-03"
          tags = {
            Name = "nat-ap-east-1-egress-02"
          }
        }
      ],
      route_table = [
        {
          ...
          subnet = ["subnet-vpc-ap-east-1-egress-01-01", "subnet-vpc-ap-east-1-egress-01-03"]
        },
        {
          vpc = "vpc-ap-east-1-egress-01"
          tags = {
        ...
        },
        {
          vpc = "vpc-ap-east-1-egress-01"
          tags = {
            Name = "rtb-vpc-ap-east-1-egress-01-03"
          }
          route = [
            { cidr_block = "0.0.0.0/0", nat_gateway = "nat-ap-east-1-egress-02" }
          ]
          subnet = ["subnet-vpc-ap-east-1-egress-01-04"]
        },
        {
      ...
      transit_gateway = [
        {
          ...
          vpc_attachment = [
            {
              vpc    = "vpc-ap-east-1-egress-01"
              subnet = ["subnet-vpc-ap-east-1-egress-01-02", "subnet-vpc-ap-east-1-egress-01-04"]
              tags = {
          ...
          route_table = [
            ...
            },
            {
              ...
              association = ["tgw-attach-tgw-ap-east-1-hub-01-vpc-ap-east-1-egress-01"]
              propagation = ["tgw-attach-tgw-ap-east-1-hub-01-vpc-ap-east-1-egress-01"]
            }
          ]
        }
      ],
      ram_resource_share = [
        {
          name                      = "share-tgw-ap-east-1-hub-01"
      ...
      security_group = [
        {
          tags = {
            Name = "sg-vpc-ap-east-1-egress-01"
          },
          vpc = "vpc-ap-east-1-egress-01"
          rule = [
      ...
      flow_log = [
        {
          ...
          transit_gateway = "tgw-ap-east-1-hub-01"
          tags = {
            Name = "flow-log-tgw-ap-east-1-hub-01"
          }
        }
      ]
    }
